...
class EntitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create entity" do
    assert_difference('Entity.count') do
      post entities_url, params: { entity: { entity_id: @entity.entity_id, entity_type: @entity.entity_type, tags: @entity.tags } }
    end
  ...
  test "should update entity" do
    patch entity_url(@entity), params: { entity: { entity_id: @entity.entity_id, entity_type: @entity.entity_type, tags: @entity.tags } }
